...
double CPU::currentUtilisation() const { return -1.0; }

double CPU::threadUtilisation(const int thread_id) const { return -1.0; }

std::vector<double> CPU::threadsUtilisation() const { return std::vector<double>(); }
